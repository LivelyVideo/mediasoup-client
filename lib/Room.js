...
export default class Room extends EnhancedEventEmitter
{
	 ...
	 * @param {Object} [options.sendTransportOptions] - Options for Transport created in mediasoup.
	 * @param {Object} [options.recvTransportOptions] - Options for Transport created in mediasoup.
